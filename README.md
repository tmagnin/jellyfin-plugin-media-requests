...
3. Tag a release. Tags need four numbers:
   ```bash
   git tag v1.0.0.0
...
5. For later versions, tag `v1.0.1.0`, `v1.1.0.0`, and so on. Older versions stay in the manifest.
...
5. Reload the web UI. **Requests** appears in the sidebar for every user.
